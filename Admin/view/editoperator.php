              ...
              <div class="profile_info">
                ...
                <?php
                    $user=$_SESSION['admin'];
                        ...
                        {
                          echo '<a href="?page=profile.php"><h2>'.$opname['kd_admin'].'</h2></a></center>';
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-newspaper-o"></i> Pinjaman Buku <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="../dashboard.php?p=view/tambahpinjaman.php">Tambah Pinjaman</a>
                      </li>
                      <li><a href="../dashboard.php?p=view/datapinjaman.php">Data Pinjaman</a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        ...
                        <span class="message">NPM 12345 Belum Di Aktifkan Sebagai Anggota, Mohon Di Aktifkan Segera..
                        </span>
                      </a>
                    </li>
                </li>
        ...
        <!-- /top navigation -->
          ...
          <div class="right_col" role="main">
            <div class="">
              ...
              $sql=mysql_query("SELECT * FROM operator WHERE kd_op='$kdop'");
              while ($row = mysql_fetch_assoc($sql))
              { ?>
              <form class="form-horizontal form-label-left" action="../controller/updateoperator.php" method="post">
              <span class="section"><center>Edit Data operator</center></span>

              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12"for="kdop">Ubah Kode Operator<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="kdop" value="<?php echo $row['kd_op']; ?>" type="text" name="kdop" class="form-control" placeholder="Kode Operator" required>
                </div>
              </div>

              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="namaop">Ubah Nama Operator<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="<?php echo $row['nama_op']; ?>" type="text" name="namaop" class="form-control" placeholder="Nama operator" required>
                </div>
              </div>

              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="notelp">Ubah No Telp<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="<?php echo $row['no_telp']; ?>" type="text" name="notelp" class="form-control" placeholder="No Telp">
                  </div>
              </div>


              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Ubah Email<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="penerbit">Ubah Username<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="jumlah">Ubah Password<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="<?php echo $row['password']; ?>" type="password" name="password" class="form-control" placeholder="password" required>
                </div>
              </div>
