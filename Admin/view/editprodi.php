                ...
                <div class="">
                  ...
                  $kd_prodi=$_GET['kd_prodi']; ?>
                              ...
                              <!-- page content -->
                                  ...
                                  $sql=mysql_query("SELECT * FROM prodi WHERE kd_prodi='$kd_prodi'");
                                  while ($row = mysql_fetch_assoc($sql));
                                  { ?>
                                  <form class="form-horizontal form-label-left" <?php echo 'action="../controller/updateprodi.php?kd_prodi='.$kd_prodi.'"'; ?> method="post">
                                  ...
                                  <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input value="<?php echo $kd_prodi ?>" type="text" name="kd_prodi" class="form-control" placeholder="Kode Prodi" required>
                                    </div>
                                  </div>

                                  <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="namaktg">Ubah Nama Prodi<span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
