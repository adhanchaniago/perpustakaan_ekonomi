                  ...
                  <li><a><i class="fa fa-male"></i> Operator <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="../dashboard.php?p=view/dataoperator.php">Data Operator</a>
                                    ...
                                    <!-- Managemen Operator -->
                                    <li><a><i class="fa fa-user"></i> Kepala Perpus <span class="fa fa-chevron-down"></span></a>
                                      <ul class="nav child_menu">
                                        <li><a href="../view/editkp.php">Data Kepala Perpus</a>
                                        </li>
                                      </ul>
                                    </li>
        ...
        <!-- /top navigation -->
          ...
          <div class="right_col" role="main">
            <div class="">
              ...
              $sql=mysql_query("SELECT * FROM kepala_perpus WHERE kd_kp='KP01'");
              while ($row = mysql_fetch_assoc($sql))
              { ?>
              <form class="form-horizontal form-label-left" action="../controller/updatekp.php" name="register" method="post">
              <span class="section"><center>Edit Data Kepala Perpus</center></span>

              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12"for="kdbuku">Kode Kepala<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="kdbuku" value="<?php echo $row['kd_kp']; ?>" type="text" name="kdkp" class="form-control" placeholder="Kode Kepala Perpus" required>
                </div>
              </div>

              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nmkp">Masukan Judul Buku<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="<?php echo $row['nama_kp']; ?>" type="text" name="nmkp" class="form-control" placeholder="Nama Kepala Perpus" required>
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="<?php echo $row['username']; ?>" type="text" name="uname" class="form-control" placeholder="Username" required>
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input value="<?php echo $row['password']; ?>" type="password" name="pass" class="form-control" placeholder="Password" required>
                </div>
              </div>
