      ...
      <div class="main_container">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-male"></i> Operator <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="?p=view/tambahoperator.php">Tambah Operator</a>
                      </li>
                      <li><a href="?p=view/dataoperator.php">Data Operator</a>
                      </li>
                    </ul>
                  </li>
        ...
        <div class="right_col" role="main">
          <?php
      		...
      		if ($p=='view/dataanggota.php' || $p=='view/databuku.php' || $p=='view/datapinjaman.php' || $p=='view/dataoperator.php' || $p=='view/datakategori.php' ) {?>
