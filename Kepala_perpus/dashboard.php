...
<html lang="en">
  <head>
    ...
    <?php
    session_start();
    $user=$_SESSION['kepala'];
    if (isset ($_SESSION['kepala']) !=NULL){ ?>
            ...
            <div class="profile">
              ...
              <div class="profile_info">
                ...
                <?php
                        ...
                        $opprofile=mysql_query("SELECT * from kepala_perpus WHERE kd_kp='$user'");
                        while ($opname=mysql_fetch_assoc($opprofile))
                        {
                          echo '<a href="?page=profile.php"><h2>'.$opname['nama_kp'].'</h2></a></center>';
                          $OPname=$opname['nama_kp'];
                        }
                ?>
                <br>
              </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-group"></i> Anggota <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="?p=view/dataanggota.php">Laporan Anggota</a>
                      </li>
                  ...
                  <li><a><i class="fa fa-book"></i> Buku <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="?p=view/databuku.php">Laporan Buku</a>
                      </li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-newspaper-o"></i> Pinjaman Buku <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="?p=view/datapinjaman.php">Laporan Pinjaman</a>
                      </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="../logout.php?user=kepala"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                    </li>
                  </ul>
                </li>
