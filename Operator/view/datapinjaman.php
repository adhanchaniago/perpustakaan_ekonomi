    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <table id="datatable" class="table-inverse table-striped table-bordered" valign="Top">
            <thead>
                <tr>
                <th>NPM</th>
                <th>
            ...
            <tbody>
              ...
              while ($row = mysql_fetch_array($sql))
              {
                ...
                ('<tr>
                  ...
                  { echo ('
                        <a href="../Operator/controller/pinjamankembali.php?nofak='.$row['id_faktur'].'&tgltem='.$row['tgl_tempo'].'">
                          <button type="button" class="btn btn-primary" btn-group btn-group-lg" name="button">
                          <i class="fa fa-check"></i></button>
                        </a>
                        <a href="../Operator/controller/hapuspinjaman.php?id_faktur='.$row['id_faktur'].'">
