...
<html lang="en">
<body>
        <form class="form-horizontal" action="../Operator/controller/inputpinjaman.php" method="post">
        <span class="section"><center>Input Data Pinjaman</center></span>
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                      ...
                      <a href="dashboard.php?p=view/datapinjaman.php"><button type="button" name="button"  class="btn btn-lg btn-danger">BATAL</button></a>
                    </div>
                  </form>
                  </body>
                </html>
