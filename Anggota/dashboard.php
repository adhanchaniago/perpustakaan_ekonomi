...
<html lang="en">
  <head>
    ...
    if (isset ($_SESSION['anggota']) !=NULL){ ?>
  ...
  <body class="nav-md">
    <div class="container body">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile">
              ...
              <div class="profile_info">
                ...
                <?php
                        ...
                        $opprofile=mysql_query("SELECT * from anggota WHERE npm='$user'");
                        while ($aname=mysql_fetch_assoc($opprofile))
                        {
                          echo '<a href="?page=profile.php"><h2>'.$aname['nama_anggota'].'</h2></a></center>';
                          $Aname=$aname['nama_anggota'];
                        }
                ?>
                <br>
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <!-- Managemen Buku -->
                  <li><a href="?p=view/databuku.php"><i class="fa fa-search"></i> Cari Buku <span></span></a>

                  <!-- Managemen Data Pinjaman -->
                  <li><a><i class="fa fa-newspaper-o"></i> Riwayat Pinjaman Buku<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="?p=view/datapinjaman1.php"> Buku Dipinjam</a>
                      </li>
                      <li><a href="?p=view/datapinjaman.php"> Buku Telah Kembali</a>
                      </li>
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/img/img.png" alt=""><?php echo $Aname; ?>
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="../logout.php?user=anggota"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                    </li>
                  </ul>
                </li>
      ...
      $p=isset ($_GET['p']) ? $_GET['p'] : 'view/dataanggota.php';?>
          ...
          <div class="">
            <?php
            $p=isset ($_GET['p']) ? $_GET['p'] : 'view/databuku.php';
            include $p; ?>
          </div>
        </div>
        <!-- /page content -->
