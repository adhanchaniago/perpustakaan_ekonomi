        ...
        <div class="x_content">
          ...
          <table id="datatable-buttons" class="table-inverse table-striped table-bordered">
            ...
            <tbody>
              ...
              WHERE anggota.npm=peminjaman.npm and buku.kd_buku=transaksi_peminjaman.kd_buku and transaksi_peminjaman.kd_peminjaman=peminjaman.kd_peminjaman and peminjaman.npm='$user' and transaksi_peminjaman.status='Sudah Kembali'");
